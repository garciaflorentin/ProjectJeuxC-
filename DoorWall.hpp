...
private:
    int nbKey; /**< Nombre de clés nécessaires pour ouvrir la porte */
...
public:
     ...
     */
    DoorWall(const char* nameObject, sf::Vector2f initPos, TypeWall _typeWall, int nbKey, int rotate) : Door(nameObject, initPos, _typeWall) {
